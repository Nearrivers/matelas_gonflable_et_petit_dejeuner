...
class ConversationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create conversation" do
    assert_difference('Conversation.count') do
      post conversations_url, params: { conversation: { user1: @conversation.user1, user2: @conversation.user2 } }
    end
  ...
  test "should update conversation" do
    patch conversation_url(@conversation), params: { conversation: { user1: @conversation.user1, user2: @conversation.user2 } }
