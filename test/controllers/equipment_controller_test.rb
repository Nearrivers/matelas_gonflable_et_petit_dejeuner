...
class EquipmentControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipment" do
    assert_difference('Equipment.count') do
      post equipment_index_url, params: { equipment: { category_id: @equipment.category_id, value: @equipment.value } }
    end
  ...
  test "should update equipment" do
    patch equipment_url(@equipment), params: { equipment: { category_id: @equipment.category_id, value: @equipment.value } }
