...
class AppliancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create appliance" do
    assert_difference('Appliance.count') do
      post appliances_url, params: { appliance: { category_id: @appliance.category_id, value: @appliance.value } }
    end
  ...
  test "should update appliance" do
    patch appliance_url(@appliance), params: { appliance: { category_id: @appliance.category_id, value: @appliance.value } }
